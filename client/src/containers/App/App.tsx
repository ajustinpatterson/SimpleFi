...
function App() {
  ...
  useEffect(() => {
    const createdTrackedTokens: any = apis.createContracts(trackedTokens, 'erc20')
    const createdTrackedFields: any = apis.createContracts(trackedFields, 'field')
 ...
 async function connectWallet () {
  ...
  return (
    <div>
      ...
      <Switch>
        <Route path='/' exact render={() => <Welcome connect={connectWallet}/>}/>
        <Route path='/dashboard' exact render={() => <MyAssets userTokens={userTokens} userFields={userFields} apis={apis} setSplash={setSplash}/>}/>
        <Route path='/dashboard/:tokenName' render={() => <HoldingDetails userTokens={userTokens} userFields={userFields}/>}/>
...
//   //Create token and field contract interfaces
//   useEffect(() => {
//     const createdTrackedTokens = apis.createContracts(trackedTokens, 'erc20')
//     const createdTrackedFields = apis.createContracts(trackedFields, 'field')
//     console.log('tokens', createdTrackedTokens)
//     console.log('fields', createdTrackedFields)
//     setTrackedTokens(createdTrackedTokens);
//     setTrackedFields(createdTrackedFields);
//     setContractsLoaded(true);
//   }, [allTrackedLoaded])
